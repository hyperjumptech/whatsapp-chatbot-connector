  ...
  async queryChatbot(body: Record<string, unknown>): Promise<void> {
    ...
    switch ((message.type as string)) {
      case "interactive":
        ...
        } else if (((message.interactive as Record<string, unknown>).type as string) === "list_reply") {
          queryText = ((message.interactive as Record<string, unknown>).list_reply as Record<string, unknown>).id as string;
        } else if (((message.interactive as Record<string, unknown>).type as string) === "nfm_reply") {
          queryText = "";
        }
        break;
